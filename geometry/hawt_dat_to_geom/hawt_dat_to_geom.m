...
function [Turbine] = hawt_dat_to_geom(dat_filename, geom_filename, rotor_params, blade_params, grid_params)
	...
	switch grid_params.node_distribution_type
		...
		case 'custom'
			...
			r_over_R_node_comp = grid_params.node_distribution;
	end

	%% Set the appropriate number of elements
	num_elems = length(r_over_R_node_comp)-1;
